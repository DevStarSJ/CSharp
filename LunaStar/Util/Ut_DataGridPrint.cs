...
/// <summary>
/// CodeProject http://www.codeproject.com/KB/printing/datagridviewprinter.aspx
/// </summary>
...
public class DataGridViewPrint
{
    ...
    DataGridViewPrinter MyDataGridViewPrinter = null;
    DataGridView MyDataGridView = null;
    String Title;

    public void Print(DataGridView DataGridView, String TItleParam)
    {
