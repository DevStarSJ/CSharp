...
namespace FTP
{
    ...
    public class FTPclient
    {
                ...
                try
                {
                    ...
                    {                        
                        do
                        {
                            ...
                            _CurrentFileSize = GetFileSize(fi.Name);
                    ...
                    using (FileStream fs = targetFI.OpenWrite())
                    {
                        try
                        {
                            ...
                            do
                            {
                                ...
                                try
                                {
                                    _CurrentFileSize = targetFI.Length;
                                }
        ...
        public bool FtpFileExists(string filename)
        {
            ...
            catch (Exception ex)
            {
                ...
                if (ex is System.Net.WebException)
                {
                    ...
                    else if (ex.Message.Contains("501"))
                    {
                        return false;
                    }
                    else
        ...
        public long GetFileSize(string filename)
        {
            ...
            //string URI = "ftp://jssystem:js0318@www.js-system.co.kr/PDS/KMNC/Ver_Info.xml";
